...
\midrule
R1 & \mref{mHH}, \mref{mParams}, \mref{mControl}\\ %\mref{mInput}, 
R2 & \mref{mParams}\\ %\mref{mInput}, 
R3 & \mref{mParams}, \mref{mSpecParams}\\ %\mref{mVerify}\\
...
\acref{acInput} & \mref{mParams}\\ %\mref{mInput}\\
\acref{acParams} & \mref{mParams}\\
\acref{acVerify} & \mref{mParams}\\ %\mref{mVerify}\\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{RevisedHierarchy.pdf}
