...
\begin{center}
	...
	07 & \shortstack{\\ $L = 0.5$ \\ $D = 0.5$ \\ $V_P = 0.5$} &error: Tank volume
	must be $>$ PCM volume & input:VpVt \\ \hline
	08 & \shortstack{\\ $V_P$\\$ = 0.199974938771605$\\ (tank volume)\\ $A_P$ \\ 
	$= 2.208137511613965$\\(tank surface area)} &error: Tank volume must be $>$ PCM volume & input:VpVt \\ \hline
	09 & $A_P = -1.5$ &error: PCM area must be $> 0$ & input:Ap\\ \hline
	10 & $A_P = 0$ &error: PCM area must be $> 0$ & input:Ap \\ \hline
	11 & $\rho_P = -1000$ &error: $\rho_P$ must be $> 0$ & input:rho\_{p} \\ \hline
	12 & $\rho_P = 0$ &error: $\rho_P$ must be $> 0$ & input:rho\_{p} \\ \hline
	13 & $T^P_{\text{melt}} = -10$ & error: $T_{\text{melt}}$ must be $> 0$ and $< T_C$ & 
	input:Tmelt \\ \hline
	14 & $T^P_{\text{melt}} = 0$ & error: $T_{\text{melt}}$ must be $> 0$ and $< T_C$ 
	&input:Tmelt \\ \hline
	15 & \shortstack{\\$T^P_{\text{melt}} = 45$\\$T_C = 40$} & error: $T_{\text{melt}}$ must
