...
Solver(T$_1$, T$_2$) with (T$_1$ = sequence[2] of $\mathbb{R}$, T$_2$ =
sequence[2] of $\mathbb{R} \rightarrow \mathbb{R}$) OR (T$_1$ = sequence[3] of
$\mathbb{R}$, $\mathbb{R}$, T$_2$ = sequence[3] of $\mathbb{R} \rightarrow \mathbb{R}$)
...
\begin{tabular}{p{2cm} p{5cm} p{2cm} p{3.5cm}}
  ...
  \textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
  \hline
  solve & T$_1$ $\rightarrow$ T$_1$, $\mathbb{R}$, T$_1$, T$_1$ $\rightarrow \mathbb{R}$ & T$_2$ & ODE\_BAD\_INPUT, ODE\_MAXSTEP, ODE\_ACCURACY \\
  \hline 
\end{tabular}
\end{center}
